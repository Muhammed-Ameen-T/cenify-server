...
exports.FetchTheatersUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const vendor_dto_1 = require("../../dtos/vendor.dto");
let FetchTheatersUseCase = class FetchTheatersUseCase {
    ...
    async execute() {
        try {
            ...
            return theaters.map((theater) => this.mapToDTO(theater));
        }
        catch (error) {
...
exports.FetchTheatersUseCase = FetchTheatersUseCase;
exports.FetchTheatersUseCase = FetchTheatersUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('TheaterRepository')),
    __metadata("design:paramtypes", [Object])
], FetchTheatersUseCase);

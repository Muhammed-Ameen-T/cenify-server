...
exports.ForgotPasswordUpdateUseCase = void 0;
 ...
 */
let ForgotPasswordUpdateUseCase = class ForgotPasswordUpdateUseCase {
    ...
    async execute(email, password) {
        ...
        try {
            ...
            throw new custom_error_1.CustomError(commonErrorMsg_constants_1.default.GENERAL.FAILED_TO_UPDATE_PASSWORD, httpResponseCode_utils_1.HttpResCode.INTERNAL_SERVER_ERROR);
        }
    }
};
exports.ForgotPasswordUpdateUseCase = ForgotPasswordUpdateUseCase;
exports.ForgotPasswordUpdateUseCase = ForgotPasswordUpdateUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('IUserRepository')),
    __metadata("design:paramtypes", [Object])
], ForgotPasswordUpdateUseCase);

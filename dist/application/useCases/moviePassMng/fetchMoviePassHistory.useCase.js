...
exports.FindMoviePassHistoryUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../utils/errors/custom.error");
const commonErrorMsg_constants_1 = __importDefault(require("../../../utils/constants/commonErrorMsg.constants"));
const httpResponseCode_utils_1 = require("../../../utils/constants/httpResponseCode.utils");
let FindMoviePassHistoryUseCase = class FindMoviePassHistoryUseCase {
    constructor(moviePassRepository) {
...
exports.FindMoviePassHistoryUseCase = FindMoviePassHistoryUseCase;
exports.FindMoviePassHistoryUseCase = FindMoviePassHistoryUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('MoviePassRepository')),
    __metadata("design:paramtypes", [Object])
], FindMoviePassHistoryUseCase);

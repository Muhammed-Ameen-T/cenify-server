...
exports.LikeOrUnlikeMovieUseCase = void 0;
// src/application/usecases/movie/likeOrUnlikeMovie.usecase.ts
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../utils/errors/custom.error");
const httpResponseCode_utils_1 = require("../../../utils/constants/httpResponseCode.utils");
const commonErrorMsg_constants_1 = __importDefault(require("../../../utils/constants/commonErrorMsg.constants"));
let LikeOrUnlikeMovieUseCase = class LikeOrUnlikeMovieUseCase {
    constructor(movieRepository) {
        this.movieRepository = movieRepository;
    }
    async execute(movieId, userId, isLike) {
...
exports.LikeOrUnlikeMovieUseCase = LikeOrUnlikeMovieUseCase;
exports.LikeOrUnlikeMovieUseCase = LikeOrUnlikeMovieUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('MovieRepository')),
    __metadata("design:paramtypes", [Object])
], LikeOrUnlikeMovieUseCase);

...
let UpdateMovieUseCase = class UpdateMovieUseCase {
    ...
    async execute(dto) {
        ...
        const updatedMovie = new movie_entity_1.Movie(dto.id, dto.name, dto.genre, dto.trailer, dto.rating, dto.poster, dto.duration, dto.description, dto.language, new Date(dto.releaseDate), existingMovie.status, existingMovie.likes, existingMovie.likedBy, dto.is3D, dto.crew, dto.cast, existingMovie.reviews);
        try {
...
exports.UpdateMovieUseCase = UpdateMovieUseCase = __decorate([

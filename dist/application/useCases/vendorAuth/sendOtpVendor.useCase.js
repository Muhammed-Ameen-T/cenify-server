...
let sendOtpVendorUseCase = class sendOtpVendorUseCase {
    ...
    async execute(dto) {
        ...
        try {
            await (0, sendOtp_service_1.sendOtp)(dto.email, otp);
